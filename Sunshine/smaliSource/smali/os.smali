...
.method public constructor <init>(Lcn/apppark/vertify/activity/persion/PersonInfo;Landroid/content/Context;)V
    ...
    iput-object p1, p0, Los;->a:Lcn/apppark/vertify/activity/persion/PersonInfo;
    ...
    invoke-virtual {p0, v3}, Los;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V

    invoke-virtual {p0, v1}, Los;->setContentView(Landroid/view/View;)V

    const/4 v0, -0x1

    invoke-virtual {p0, v0}, Los;->setWidth(I)V

    const/4 v0, -0x2

    invoke-virtual {p0, v0}, Los;->setHeight(I)V

    invoke-virtual {p0, v2}, Los;->setOutsideTouchable(Z)V

    invoke-virtual {p0, v2}, Los;->setTouchable(Z)V
