...
.field private static final DETAIL_METHOD:Ljava/lang/String; = "product_sd"

.field private static final GETCAR_WHAT:I = 0x5

.field private static final GET_WHAT:I = 0x1

.field public static final METHOD_GETCAR:Ljava/lang/String; = "myShoppingCart_sd"
...
.method private addBuyCar(ILjava/lang/String;)V
    ...
    iget-object v2, p0, Lcn/apppark/vertify/activity/buy/BuyProductDetail;->handler:Lfj;
...
.method private initGalleryData()V
    ...
    invoke-direct {v1, p0, v2, v3}, Lfh;-><init>(Lcn/apppark/vertify/activity/buy/BuyProductDetail;Landroid/content/Context;[Ljava/lang/String;)V
...
.method private setData()V
    ...
    invoke-direct {v1, p0}, Lfe;-><init>(Lcn/apppark/vertify/activity/buy/BuyProductDetail;)V
...
.method private updateHistoryFile()V
    ...
    invoke-virtual {v1}, Lfg;->getType()Ljava/lang/reflect/Type;
...
.method protected onActivityResult(IILandroid/content/Intent;)V
    ...
    iget-object v1, p0, Lcn/apppark/vertify/activity/buy/BuyProductDetail;->tv_carnumber:Landroid/widget/TextView;
...
.method public onClick(Landroid/view/View;)V
    ...
    invoke-virtual {v0}, Lcn/apppark/mcd/vo/buy/BuyProductVo;->getIsStandard()I
    ...
    iput-boolean v2, p0, Lcn/apppark/vertify/activity/buy/BuyProductDetail;->isFinish:Z
    ...
    iget-object v1, p0, Lcn/apppark/vertify/activity/buy/BuyProductDetail;->pics:[Ljava/lang/String;
    ...
    const-class v3, Lcn/apppark/vertify/activity/buy/BuyProductStandard;

    invoke-direct {v1, v2, v3}, Landroid/content/Intent;-><init>(Landroid/content/Context;Ljava/lang/Class;)V

    const-string v2, "relation"

    iget-object v3, p0, Lcn/apppark/vertify/activity/buy/BuyProductDetail;->productVo:Lcn/apppark/mcd/vo/buy/BuyProductVo;

    invoke-virtual {v3}, Lcn/apppark/mcd/vo/buy/BuyProductVo;->getStandardRelation()Ljava/util/ArrayList;
    ...
    invoke-virtual {v3}, Lcn/apppark/mcd/vo/buy/BuyProductVo;->getStandard()Lcn/apppark/mcd/vo/buy/BuyProductStandardVo;
    ...
    invoke-virtual {v3}, Lcn/apppark/mcd/vo/buy/BuyProductVo;->getProductSum()I
    ...
    invoke-virtual {v2}, Lcn/apppark/mcd/vo/buy/BuyProductVo;->getPriceRange()Ljava/lang/String;
    ...
    invoke-virtual {p0, v0, v2}, Lcn/apppark/vertify/activity/buy/BuyProductDetail;->overridePendingTransition(II)V

    invoke-virtual {p0, v1, v4}, Lcn/apppark/vertify/activity/buy/BuyProductDetail;->startActivityForResult(Landroid/content/Intent;I)V
    ...
    .sparse-switch
        ...
        0x7f0a010a -> :sswitch_4
        0x7f0a0112 -> :sswitch_1
        0x7f0a0113 -> :sswitch_3
        0x7f0a0116 -> :sswitch_2
    .end sparse-switch
.end method
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-direct {v0, p0}, Lfj;-><init>(Lcn/apppark/vertify/activity/buy/BuyProductDetail;)V

    iput-object v0, p0, Lcn/apppark/vertify/activity/buy/BuyProductDetail;->handler:Lfj;
