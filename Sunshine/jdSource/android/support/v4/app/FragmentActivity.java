  ...
  extends Activity
{
  ...
  public final Object onRetainNonConfigurationInstance()
  {
    ...
    if (this.mAllLoaderManagers != null)
    {
      int j = this.mAllLoaderManagers.size() - 1;
      k = i;
      if (j >= 0)
      {
        localObject2 = (LoaderManagerImpl)this.mAllLoaderManagers.valueAt(j);
  ...
  protected void onStart()
  {
    ...
    for (;;)
    {
      ...
      int i = this.mAllLoaderManagers.size() - 1;
      while (i >= 0)
      {
...
/* Location:              /Users/makito/Apktool/sunshine_app.apk/classes-dex2jar.jar!/android/support/v4/app/FragmentActivity.class
