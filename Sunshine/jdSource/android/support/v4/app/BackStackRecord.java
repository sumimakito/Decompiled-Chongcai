  ...
  implements FragmentManager.BackStackEntry, Runnable
{
  ...
  public void dump(String paramString, FileDescriptor paramFileDescriptor, PrintWriter paramPrintWriter, String[] paramArrayOfString)
  {
    ...
    if (this.mHead != null)
    {
      ...
      for (paramFileDescriptor = this.mHead; paramFileDescriptor != null; paramFileDescriptor = paramFileDescriptor.next)
      {
        paramPrintWriter.print(paramString);
...
/* Location:              /Users/makito/Apktool/sunshine_app.apk/classes-dex2jar.jar!/android/support/v4/app/BackStackRecord.class
