...
public class DataProfile
{
  ...
  private JSONArray GetWifiToJson(List<WifiCollectInfo> paramList)
  {
    ...
    for (;;)
    {
      ...
      break;
      label143:
      localJSONObject.put(LocationNameEnum.BSSID.getValue(), localJSONException.getMbssid());
      continue;
      label162:
      localJSONObject.put(LocationNameEnum.SSID.getValue(), localJSONException.getMssid());
    }
  }
...
/* Location:              /Users/makito/Apktool/sunshine_app.apk/classes-dex2jar.jar!/com/alipay/mobilesecuritysdk/model/DataProfile.class
