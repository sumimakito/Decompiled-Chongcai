...
public class NetStatusUtil
{
  ...
  public static int getNetType(Context paramContext)
  {
    ...
    Log.d("MicroMsg.NetStatusUtil", "activeNetInfo.getExtraInfo()  " + paramContext.getExtraInfo());
    Log.d("MicroMsg.NetStatusUtil", "activeNetInfo.getType()  " + paramContext.getType());
  ...
  public static boolean runRootCommand()
  {
    ...
    //   2: aconst_null
    //   3: astore_2
    //   4: invokestatic 443	java/lang/Runtime:getRuntime	()Ljava/lang/Runtime;
    //   7: ldc_w 445
    //   10: invokevirtual 449	java/lang/Runtime:exec	(Ljava/lang/String;)Ljava/lang/Process;
    //   13: astore_0
    //   14: new 451	java/io/DataOutputStream
    //   17: dup
    //   18: aload_0
    //   19: invokevirtual 457	java/lang/Process:getOutputStream	()Ljava/io/OutputStream;
    //   22: invokespecial 460	java/io/DataOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   25: astore_1
    //   26: aload_1
    //   27: ldc_w 462
    //   30: invokevirtual 465	java/io/DataOutputStream:writeBytes	(Ljava/lang/String;)V
    //   33: aload_1
    //   34: invokevirtual 468	java/io/DataOutputStream:flush	()V
    //   37: aload_0
    //   38: invokevirtual 471	java/lang/Process:waitFor	()I
    //   41: pop
    //   42: aload_1
    //   43: invokevirtual 474	java/io/DataOutputStream:close	()V
    //   46: aload_0
    //   47: ifnull +7 -> 54
    //   50: aload_0
    //   51: invokevirtual 477	java/lang/Process:destroy	()V
    //   54: iconst_1
    //   55: ireturn
    //   56: astore_0
    //   57: aload_0
    //   58: invokevirtual 154	java/lang/Exception:printStackTrace	()V
    //   61: goto -7 -> 54
    //   64: astore_0
    //   65: aconst_null
    //   66: astore_1
    //   67: ldc 64
    //   69: new 66	java/lang/StringBuilder
    //   72: dup
    //   73: ldc_w 479
    //   76: invokespecial 71	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   79: aload_0
    //   80: invokevirtual 482	java/lang/Exception:getMessage	()Ljava/lang/String;
    ...
    //   89: invokestatic 334	com/tencent/mm/sdk/platformtools/Log:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   92: aload_1
    //   93: ifnull +7 -> 100
    //   96: aload_1
    //   97: invokevirtual 474	java/io/DataOutputStream:close	()V
    //   100: aload_2
    //   101: ifnull +7 -> 108
    //   104: aload_2
    //   105: invokevirtual 477	java/lang/Process:destroy	()V
    //   108: iconst_0
    //   109: ireturn
    //   110: astore_0
    //   111: aload_0
    //   112: invokevirtual 154	java/lang/Exception:printStackTrace	()V
    //   115: goto -7 -> 108
    //   118: astore_0
    //   119: aconst_null
    //   120: astore_3
    ...
    //   126: ifnull +7 -> 133
    //   129: aload_1
    //   130: invokevirtual 474	java/io/DataOutputStream:close	()V
    //   133: aload_2
    //   134: ifnull +7 -> 141
    //   137: aload_2
    //   138: invokevirtual 477	java/lang/Process:destroy	()V
    //   141: aload_0
    //   142: athrow
    //   143: astore_1
    //   144: aload_1
...
/* Location:              /Users/makito/Apktool/sunshine_app.apk/classes-dex2jar.jar!/com/tencent/mm/sdk/platformtools/NetStatusUtil.class
