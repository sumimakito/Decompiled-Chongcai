...
{
  public qk(Soft paramSoft) {}
  
  public final void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    Soft.n(this.a).get(paramInt - 1);
    paramAdapterView = new Intent(this.a, SoftDetail.class);
    paramAdapterView.putExtra("id", ((SoftReturnVo)Soft.n(this.a).get(paramInt - 1)).getId());
...
/* Location:              /Users/makito/Apktool/sunshine_app.apk/classes-dex2jar.jar!/qk.class
