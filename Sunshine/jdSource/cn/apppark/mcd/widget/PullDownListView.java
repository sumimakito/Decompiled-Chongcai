  ...
  implements AbsListView.OnScrollListener
{
  ...
  private PullDownListView.OnFootRefreshListener onFootrefreshListener;
  private ProgressBar progressBar;
  private PullDownListView.OnRefreshListener refreshListener;
  private int startY;
  private int state;
  ...
  private void init(Context paramContext)
  {
    ...
    this.footView = ((FrameLayout)this.inflater.inflate(2130903156, null));
    ...
    this.foot_btn.setOnClickListener(new PullDownListView.1(this));
    this.state = 3;
  ...
  {
    System.out.println("count..." + paramInt1 + " currentSize.." + paramInt2);
  ...
  public void setonFootRefreshListener(PullDownListView.OnFootRefreshListener paramOnFootRefreshListener)
  {
    this.onFootrefreshListener = paramOnFootRefreshListener;
  }
  
  public void setonRefreshListener(PullDownListView.OnRefreshListener paramOnRefreshListener, boolean paramBoolean)
  {
...
/* Location:              /Users/makito/Apktool/sunshine_app.apk/classes-dex2jar.jar!/cn/apppark/mcd/widget/PullDownListView.class
