  ...
  extends AlertDialog
{
  ...
  protected DialogTwoBtn(Context paramContext)
  {
    super(paramContext);
    this.mContext = paramContext;
    this.mInflater = LayoutInflater.from(this.mContext);
    this.mView = ((LinearLayout)this.mInflater.inflate(2130903092, null));
  ...
  public void setButton(CharSequence paramCharSequence, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    localButton.setOnClickListener(new DialogTwoBtn.2(this, paramOnClickListener));
  ...
  {
    Button localButton = (Button)this.mView.findViewById(2131362189);
    ButtonColorFilter.setButtonFocusChanged(localButton);
    localButton.setText(paramCharSequence);
    localButton.setVisibility(0);
    localButton.setOnClickListener(new DialogTwoBtn.3(this, paramOnClickListener));
    super.setButton3(paramCharSequence, paramOnClickListener);
  }
  ...
  public void setTitle(CharSequence paramCharSequence)
  {
    ...
    this.mItemTitle.setOnClickListener(new DialogTwoBtn.1(this));
  }
}


/* Location:              /Users/makito/Apktool/sunshine_app.apk/classes-dex2jar.jar!/cn/apppark/mcd/widget/DialogTwoBtn.class
