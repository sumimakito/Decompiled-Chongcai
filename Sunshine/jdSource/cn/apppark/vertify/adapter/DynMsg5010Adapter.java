...
public class DynMsg5010Adapter
  extends TempBaseAdapter
{
  ...
  public DynMsg5010Adapter(Context paramContext, DynMsgListVo paramDynMsgListVo, ArrayList<DynMsgListReturnVo> paramArrayList)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      paramViewGroup = new tx();
      paramViewGroup.a = ((LinearLayout)paramView.findViewById(2131362240));
      paramViewGroup.b = ((RemoteImageView)paramView.findViewById(2131362241));
      paramViewGroup.c = ((RemoteImageView)paramView.findViewById(2131362248));
      paramViewGroup.g = ((TextView)paramView.findViewById(2131362246));
      paramViewGroup.h = ((TextView)paramView.findViewById(2131362245));
      paramViewGroup.d = ((TextView)paramView.findViewById(2131362242));
      paramViewGroup.e = ((TextView)paramView.findViewById(2131362243));
      paramViewGroup.f = ((TextView)paramView.findViewById(2131362247));
      paramViewGroup.i = ((ImageView)paramView.findViewById(2131362244));
    ...
    for (;;)
    {
      ...
      return paramView;
      paramViewGroup = (tx)paramView.getTag();
      break;
...
/* Location:              /Users/makito/Apktool/sunshine_app.apk/classes-dex2jar.jar!/cn/apppark/vertify/adapter/DynMsg5010Adapter.class
