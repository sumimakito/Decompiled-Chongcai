...
public class SelfGridView4008Adapter
  extends TempBaseAdapter
{
  ...
  public SelfGridView4008Adapter(Context paramContext, SelfGridItemVo paramSelfGridItemVo, ArrayList<SelfGridItem2Vo> paramArrayList)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      paramView = this.mInflater.inflate(2130903189, null);
      paramViewGroup = new us(this);
      paramViewGroup.a = ((FrameLayout)paramView.findViewById(2131362729));
    ...
    for (;;)
    {
      ...
      return paramView;
      paramViewGroup = (us)paramView.getTag();
    }
  }
}


/* Location:              /Users/makito/Apktool/sunshine_app.apk/classes-dex2jar.jar!/cn/apppark/vertify/adapter/SelfGridView4008Adapter.class
