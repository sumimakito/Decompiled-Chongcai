  ...
  extends Activity
{
  ...
  private void initWidget()
  {
    ...
    ((TextView)findViewById(2131362769)).setText(2131230768);
    ...
    this.btn_return.setOnClickListener(new WeixinShareAct.MyBtnClickListener(this, null));
    this.btn_share.setOnClickListener(new WeixinShareAct.MyBtnClickListener(this, null));
    ButtonColorFilter.setButtonFocusChanged(this.btn_return);
    ButtonColorFilter.setButtonFocusChanged(this.btn_share);
    localObject = new qb(this);
...
/* Location:              /Users/makito/Apktool/sunshine_app.apk/classes-dex2jar.jar!/cn/apppark/vertify/activity/share/WeixinShareAct.class
