...
public class BuyCollectionMsgList
  extends BuyBaseAct
  implements View.OnClickListener
{
  ...
  private void delData(String paramString, int paramInt)
  {
    ...
    paramString = new WebServicePool(paramInt, this.handler, "json", map2Json(localHashMap), "http://ws.ckj.hqch.com", "http://www.apppark.cn/member.ws", "deleteNewsFavorites");
  ...
  private void initWidget()
  {
    ...
    this.ll_null.setVisibility(8);
    this.btn_back = ((Button)findViewById(2131361856));
    ButtonColorFilter.setButtonFocusChanged(this.btn_back);
    this.btn_back.setOnClickListener(this);
    this.listView = ((PullDownListView)findViewById(2131361857));
    this.listView.setonRefreshListener(new cf(this), true);
    this.listView.setonFootRefreshListener(new cg(this));
    this.listView.setOnItemClickListener(new ch(this));
    this.listView.setOnItemLongClickListener(new ci(this));
  }
  ...
  public void del()
  {
    if (this.isFinish)
    {
      ...
      this.isFinish = false;
      delData(((DynMsgListReturnVo)this.itemList.get(this.currentDelPositon)).getId(), 3);
    }
  }
...
/* Location:              /Users/makito/Apktool/sunshine_app.apk/classes-dex2jar.jar!/cn/apppark/vertify/activity/buy/BuyCollectionMsgList.class
