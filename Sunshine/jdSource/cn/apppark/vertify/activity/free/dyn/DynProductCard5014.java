...
public class DynProductCard5014
  ...
  implements View.OnClickListener, ISelfViewDyn
{
  ...
  private DynProduct5014Adapter adapter;
  ...
  public DynProductCard5014(Context paramContext, FreePageVo paramFreePageVo, DynProductVo paramDynProductVo, ElasticScrollView paramElasticScrollView)
  {
    super(paramContext);
  ...
  private void initWidget()
  {
    ...
    this.et_keyWord.setListener(new ir(this));
    ...
    this.listView.setOnItemClickListener(new is(this));
    this.listView.setonFootRefreshListener(new it(this));
...
/* Location:              /Users/makito/Apktool/sunshine_app.apk/classes-dex2jar.jar!/cn/apppark/vertify/activity/free/dyn/DynProductCard5014.class
