...
public class DynProductNine5005
  ...
  implements View.OnClickListener, ISelfViewDyn
{
  ...
  ClientPersionInfo a;
  private DynProduct5005Adapter adapter;
  ...
  public DynProductNine5005(Context paramContext, FreePageVo paramFreePageVo, DynProductVo paramDynProductVo, ElasticScrollView paramElasticScrollView)
  {
    super(paramContext);
  ...
  private void initWidget()
  {
    ...
    this.et_keyWord = ((EditText)localView.findViewById(2131362291));
    this.et_keyWord.setSingleLine(true);
    this.et_keyWord.setImeOptions(3);
    this.et_keyWord.setOnKeyListener(new jh(this));
    ...
    this.listView.setOnItemClickListener(new ji(this));
    this.listView.setonFootRefreshListener(new jj(this));
...
/* Location:              /Users/makito/Apktool/sunshine_app.apk/classes-dex2jar.jar!/cn/apppark/vertify/activity/free/dyn/DynProductNine5005.class
