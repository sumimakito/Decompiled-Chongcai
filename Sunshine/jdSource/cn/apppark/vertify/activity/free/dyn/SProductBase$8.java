...
class SProductBase$8
  implements View.OnClickListener
{
  SProductBase$8(SProductBase paramSProductBase) {}
  ...
  public void onClick(View paramView)
  {
    ...
    while (i < SProductBase.g(this.a).size())
    {
      ...
      ((Button)SProductBase.g(this.a).get(i)).setBackgroundResource(2130837947);
    ...
    ((Button)SProductBase.g(this.a).get(j)).setBackgroundResource(2130837931);
...
/* Location:              /Users/makito/Apktool/sunshine_app.apk/classes-dex2jar.jar!/cn/apppark/vertify/activity/free/dyn/SProductBase$8.class
