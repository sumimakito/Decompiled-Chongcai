  ...
  implements ISelfViewDyn
{
  ...
  public DynMsgCard5011(Context paramContext, FreePageVo paramFreePageVo, DynMsgListVo paramDynMsgListVo, ElasticScrollView paramElasticScrollView)
  {
    super(paramContext);
    this.context = paramContext;
    this.itemVo = paramDynMsgListVo;
    this.handler = new hc(this, null);
    setCacheColorHint(0);
    ...
    setOnItemClickListener(new ha(this));
    setonFootRefreshListener(new hb(this));
...
/* Location:              /Users/makito/Apktool/sunshine_app.apk/classes-dex2jar.jar!/cn/apppark/vertify/activity/free/dyn/DynMsgCard5011.class
