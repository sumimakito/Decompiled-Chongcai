...
import cn.apppark.vertify.adapter.SelfListView4002Adapter;
import java.util.ArrayList;
import nl;
import nm;

public class SelfListView4002
  extends ListView
  implements ISelfView
{
  private SelfListView4002Adapter adapter;
  private int firstItemIndex = 0;
  private ScrollView parentScroll;
  
  public SelfListView4002(Context paramContext, FreePageVo paramFreePageVo, SelfListViewItemVo paramSelfListViewItemVo, ArrayList<SelfListViewItem2Vo> paramArrayList, ScrollView paramScrollView)
  {
    super(paramContext);
    this.adapter = new SelfListView4002Adapter(paramContext, paramSelfListViewItemVo, paramArrayList);
    ...
    setOnItemClickListener(new nl(this, paramArrayList, paramFreePageVo));
    setOnScrollListener(new nm(this));
...
/* Location:              /Users/makito/Apktool/sunshine_app.apk/classes-dex2jar.jar!/cn/apppark/vertify/activity/free/typelist/SelfListView4002.class
