...
public class SelfGridView4007
  extends GridView
  implements ISelfView
{
  private SelfGridView4007Adapter adapter;
  ...
  public SelfGridView4007(Context paramContext, FreePageVo paramFreePageVo, SelfGridItemVo paramSelfGridItemVo, ArrayList<SelfGridItem2Vo> paramArrayList, ScrollView paramScrollView)
  {
    super(paramContext);
  ...
  public void init()
  {
    ...
    this.adapter = new SelfGridView4007Adapter(this.context, this.vo, this.item2List);
    setOnItemClickListener(new nu(this));
...
/* Location:              /Users/makito/Apktool/sunshine_app.apk/classes-dex2jar.jar!/cn/apppark/vertify/activity/free/typenine/SelfGridView4007.class
