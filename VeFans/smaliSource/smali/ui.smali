...
.method public constructor <init>(Lcn/apppark/vertify/base/ImagePreview;Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lui;->a:Lcn/apppark/vertify/base/ImagePreview;
    ...
    invoke-virtual {p0, v0}, Lui;->setAnimationStyle(I)V

    invoke-virtual {p0, v3}, Lui;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V

    invoke-virtual {p0, v1}, Lui;->setContentView(Landroid/view/View;)V

    const/4 v0, -0x1

    invoke-virtual {p0, v0}, Lui;->setWidth(I)V

    const/4 v0, -0x2

    invoke-virtual {p0, v0}, Lui;->setHeight(I)V

    invoke-virtual {p0, v2}, Lui;->setOutsideTouchable(Z)V

    invoke-virtual {p0, v2}, Lui;->setTouchable(Z)V
