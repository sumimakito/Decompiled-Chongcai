...
.method public constructor <init>(Lcom/nostra13/universalimageloader/core/ImageLoaderConfiguration;)V
    ...
    iput-object v0, p0, Lwg;->e:Ljava/util/Map;

    new-instance v0, Ljava/util/WeakHashMap;

    invoke-direct {v0}, Ljava/util/WeakHashMap;-><init>()V

    iput-object v0, p0, Lwg;->f:Ljava/util/Map;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object v0, p0, Lwg;->g:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object v0, p0, Lwg;->h:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object v0, p0, Lwg;->i:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, Lwg;->j:Ljava/lang/Object;

    iput-object p1, p0, Lwg;->a:Lcom/nostra13/universalimageloader/core/ImageLoaderConfiguration;

    iget-object v0, p1, Lcom/nostra13/universalimageloader/core/ImageLoaderConfiguration;->g:Ljava/util/concurrent/Executor;

    iput-object v0, p0, Lwg;->b:Ljava/util/concurrent/Executor;

    iget-object v0, p1, Lcom/nostra13/universalimageloader/core/ImageLoaderConfiguration;->h:Ljava/util/concurrent/Executor;

    iput-object v0, p0, Lwg;->c:Ljava/util/concurrent/Executor;
    ...
    iput-object v0, p0, Lwg;->d:Ljava/util/concurrent/Executor;
...
.method public final a(Ljava/lang/String;)Ljava/util/concurrent/locks/ReentrantLock;
    ...
    iget-object v0, p0, Lwg;->f:Ljava/util/Map;
    ...
    iget-object v1, p0, Lwg;->f:Ljava/util/Map;
...
.method public final a()V
    ...
    iget-object v0, p0, Lwg;->a:Lcom/nostra13/universalimageloader/core/ImageLoaderConfiguration;

    iget-boolean v0, v0, Lcom/nostra13/universalimageloader/core/ImageLoaderConfiguration;->i:Z

    if-nez v0, :cond_0

    iget-object v0, p0, Lwg;->b:Ljava/util/concurrent/Executor;
    ...
    iget-object v1, p0, Lwg;->a:Lcom/nostra13/universalimageloader/core/ImageLoaderConfiguration;

    iget v1, v1, Lcom/nostra13/universalimageloader/core/ImageLoaderConfiguration;->l:I

    iget-object v2, p0, Lwg;->a:Lcom/nostra13/universalimageloader/core/ImageLoaderConfiguration;
    ...
    iget-object v0, p0, Lwg;->c:Ljava/util/concurrent/Executor;
